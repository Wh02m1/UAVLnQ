...
//---------------------------------------------------------------------------------------------------------------------------
    ...
    oss << "/bath/to/change/drone-mesh-" // Change this to where you want to save the PCAP files
        << std::put_time(&tm, "%Y%m%d_%H%M%S");
    std::string outputPrefix = oss.str();

    std::ostringstream animOss;
    animOss << "/bath/to/change/drone-mesh-anim_"  // Change this to where you want to save the anim output 
