...
| #  | Attack Name                          | Function(s)                                | Description |
|----|--------------------------------------|--------------------------------------------|-------------|
...
| 9  | Heartbeat Flood DoS                   | `CreateRealisticHeartbeatPacket` / `ExecuteHeartbeatFloodAttack` | Floods the network with a MAVLink `HEARTBEAT`  from multiple spoofed drones (IDs 4–20). Overloads communication and processing. |
